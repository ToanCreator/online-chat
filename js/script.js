...
function registerUser() {
    ...
    console.log('Đang đăng ký user:', currentUser); // Thêm log kiểm tra
    ...
    database.ref('users/' + userIdValue).set({
        ...
        console.log('Đăng ký Firebase thành công'); // Thêm log kiểm tra
        termsModal.style.display = 'none';
        ...
        console.error('Lỗi khi đăng ký Firebase:', error);
